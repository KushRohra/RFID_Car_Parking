...
<!-- HTML for changing password for the first time -->
 ...
 <h1 class = "jumbotron text-center">Change Password</h1>
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="newpassword" aria-describedby="emailHelp" placeholder="Enter email" name = "pass">
    
  </div>
  <div class="form-group">
    <label for="retypepassword">Re-type Password</label>
    <input type="password" class="form-control" id="retypepassword" placeholder="Password" name = "repass">
  </div>
